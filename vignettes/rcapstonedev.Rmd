---
title: "rcapstonedev package usage"
date: "`r Sys.Date()`"
output: 
...
Function and data from **rcapstonedev** package would be useful to show
...
the following characteristics:
 ...
 - use the funciton `eq_location_clean()` (from the **rcapstonedev** package
...
Using the ggplot2 geom `geom_timeline()` provided by **rcapstonedev**,
